...
$taskName = "AD-user-generate-table-report-recently-changed"
$taskGetAdUsersGuid = ""
...
$dataSourceName = "AD-user-generate-table-report-recently-changed"
...
try {
    ...
    if([string]::IsNullOrEmpty($response.dataSourceGUID)) {
        ...
        $body = @{
            name = "$dataSourceName";
            type = "3";
            model = @(@{key = "CanonicalName"; type = 0}, @{key = "Department"; type = 0}, @{key = "Displayname"; type = 0}, @{key = "Enabled"; type = 0}, @{key = "SamAccountName"; type = 0}, @{key = "Title"; type = 0}, @{key = "UserPrincipalName"; type = 0}, @{key = "whenChanged"; type = 0});
...
$formName = "AD - Report - Accounts changed during the last 30 days"
$formGuid = ""
...
try
{
        ...
        [
  {
    ...
    "body": "The following report will show local AD accounts that have been changed during the last 30 days. Please wait while the data is loading...",
...
$delegatedFormName = "AD - Report - Accounts changed during the last 30 days"
$delegatedFormGuid = ""
...
$taskActionName = "AD-export-report-accounts-recently-changed"
$taskActionGuid = ""
